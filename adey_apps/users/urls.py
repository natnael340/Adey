...
from adey_apps.users.views import LoginView, SignUpView, GoogleLogin, PlanViewSet, SubscriptionApiView, Subscribe
...
urlpatterns = [
    ...
    path("user/subscribe/<str:plan>/<str:period>", Subscribe.as_view(), name="subscribe"),
]
