        ...
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              ...
              !plan.isPopular && "mt-5",
              index === 0 || index === 2
                ? "z-0 -translate-z-[50px] translate-x-0 translate-y-0 rotate-y-[10deg]"
                : "z-10",
            ...
            <div className="flex flex-1 flex-col">
              ...
              <Link
                ...
                className={cn(
                  ...
                  "group relative w-full transform-gpu gap-2 overflow-hidden text-lg font-semibold tracking-tighter ring-offset-current transition-all duration-300 ease-out hover:bg-primary hover:text-primary-foreground hover:ring-2 hover:ring-primary hover:ring-offset-1",
                  plan.isPopular
